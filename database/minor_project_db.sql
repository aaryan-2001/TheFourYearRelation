...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 30, 2021 at 08:11 AM
...
(16, 'Divyani choudhary', 1234567890, 'wewewe'),
(17, 'Divyani choudhary', 7869602166, 'hi');
...
(1, 'mainadmin', 'Admin', 'Aryan', '987654321', 1, 1, 'trial', 1),
(20, 'aryan', 'aryan', 'shah', '1234567890', 1, 1, '$2y$10$zZ2SbPKvMgU9KkmcrVxcWOPtCWTr1/yAaQmL0Cckr419s4omIEL3.', 0),
(22, '1234aryan', 'Aryan', 'Shah', '1234567890', 2, 2, '$2y$10$ZegaLqw88YIqs8TzV4Rs/OJkz7WbUBm/ZgZs0My5K43NxClUvzoIm', 0);
...
('123', 'mo', 'mi', '12345678', 'computer science and engineering', '5', '$2y$10$8MQfqfTravcazl/e56B5.uksCMMfRy2Z81K3Vw3d4K4oIvogmIZWS', NULL, NULL, NULL, NULL),
('aryan', 'ARYAN', 'SHAH', '+916265853149', 'cs', '2', '$2y$10$hPMdDI1L5qNdXxpGskrcYuhFjRxzNxFReFqhn3pmjM70hgRXUlkAu', 2, 1, NULL, NULL);
...
--
ALTER TABLE `application_mess`
  MODIFY `Application_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `hostel_manager`
  MODIFY `Hostel_man_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT for table `mess`
--
ALTER TABLE `mess`
  MODIFY `Mess_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
