...
<head>
    ...
    <!-- /meta tags -->
    <!-- custom style sheet -->
    <link href="web_login/css/style2.css" rel="stylesheet" type="text/css" />
    <!-- /custom style sheet -->
    <!-- fontawesome css -->
    <link href="web_login/css/fontawesome-all.css" rel="stylesheet" />
    <!-- /fontawesome css -->
    <!-- google fonts-->
...
<body>
    ...
    <footer>
        <p class="copyright-agileinfo"> &copy; 2021 The Four Year Relation Project. All Rights Reserved</p>
    </footer>
