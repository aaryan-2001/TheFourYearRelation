...
<section class="contact py-5">
	<div class="container">
		<h2 class="heading text-capitalize mb-sm-5 mb-4"> Complaint Form </h2>
				...
				<form action="complaint_form.php" method="POST">
					<div class="row">
                        ...
                        <div class="contact-fields-w3ls">
							...
							<input type="submit" name="submitcomp" value="Raise a complaint">
						</div>
					</div>
...
<footer class="py-5">
	<div class="container py-md-5">
		<div class="footer-logo mb-5 text-center">
			<a class="navbar-brand" href="http://sistec.ac.in" target="_blank">sistec <span class="display"> gandhi nagar, bhopal</span></a>
		</div>
...
<?php
   ...
   if(isset($_POST['submitcomp'])){
     ...
     $query_imp = "SELECT * FROM complaint WHERE Student_id = '$roll'";
     ...
     if(($status)==0){
		     ...
		     if($row = mysqli_fetch_assoc($result)){
		        ...
		        if($pwdCheck == false){
		            ...
		            $query3 = "INSERT INTO complaint (Student_id,status,Message) VALUES ('$roll',true,'$message')";
