...
<body>
		...
		<header>
			<div class="container agile-banner_nav">
				<nav class="navbar navbar-expand-lg navbar-light bg-light">
					<h1><a class="navbar-brand" href="home_manager.php">sistec <span class="display"></span></a></h1>
					...
					<div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
						<ul class="navbar-nav ml-auto">
							...
							<li class="dropdown nav-item">
								<a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">Allotment
									<b class="caret"></b>
								</a>
								<ul class="dropdown-menu agile_short_dropdown">
									...
									<li>
										<a href="allocate_mess_card.php">Allocate Mess</a>
									</li>
								</ul>
							</li>
							...
							<li class="nav-item ">
								<a class="nav-link" href="complaint_sol.php">complaints</a>
							</li>
							<li class="dropdown nav-item">
	...
	<section class="contact py-5">
		<div class="container">
			<div class="mail_grid_w3l">
				<form action="complaint_sol.php" method="post">
					<div class="row">
						<div class="col-md-9">
							<input type="text" placeholder="Search by Roll Number" name="search_box">
						</div>
						<div class="col-md-3">
							<input type="submit" value="Search" name="searchcomp"></input>
						</div>
					</div>
				</form>
			</div>
	...
	if (isset($_POST['searchcomp'])) {
		...
		$query_search = "SELECT * FROM complaint WHERE Student_id like '$search_box%'  and status = '1'";
				...
				<tbody>
					...
					if (mysqli_num_rows($result_search) == 0) {
						...
						while ($row_search = mysqli_fetch_assoc($result_search)) {
                            ...
                            $query8 = "SELECT message FROM complaint";
                            $result8 = mysqli_query($conn, $query8);
							$row8 = mysqli_fetch_assoc($result8);
                            $message = $row8['message'];

							echo "<tr><td>{$student_name}</td><td>{$row_search['Student_id']}</td><td>{$message}</td></tr>\n";
						}
					}
					?>
				</tbody>
			...
			<tbody>
				...
				if (mysqli_num_rows($result1) == 0) {
					...
					while ($row1 = mysqli_fetch_assoc($result1)) {
                        ...
                        echo "<tr><td>{$student_name}</td><td>{$row7['Student_id']}</td><td>{$message}</td></tr>\n";
	...
	<footer class="py-5">
		<div class="container py-md-5">
			<div class="footer-logo mb-5 text-center">
				<a class="navbar-brand" href="http://www.sistec.ac.in/" target="_blank">sistec<span class="display"> gandhi nagar, bhopal</span></a>
			</div>
