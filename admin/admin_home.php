...
<header>
	<div class="container agile-banner_nav">
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			...
			<h1><a class="navbar-brand" href="admin_home.php">sistec<span class="display"></span></a></h1>
          ...
          <li class="nav-item">
					...
					<li class="nav-item">
						<a class="nav-link" href="admin_contact.php">Communication</a>
					</li>
					<li>
						<a class="nav-link" href="url">Hostel</a>
					</li>
